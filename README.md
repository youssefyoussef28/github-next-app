...
Concepts Learned from this Application

- Layout : Creating a layout.jsx file in any page-folder/app-directory can alter the layout of the page.
...
- Suspense Boundaries provide a much better user Experience as we can define a fallback prior to a component loading. Thus not holding up one page for one request.
